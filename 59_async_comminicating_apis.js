...
async function queryApis() {                                                                        //async function then function declaration queryApis no args
    ...
    const repos = await reposPromise.then(res => res.json());                   // variable repos equals await then call reposPromise then and pass in a function-response arrow function json(to tell it what to 
                                                                                                                                 // cont....return and how)
    console.log(repos);
  }
